...
from detect import ProductDetector # 載入專案內原本寫好的偵測器
...
class YoloTkinterApp:
    def __init__(self, root):
        ...
        # ==========================================
        try:
            # 建立 YOLO 模型偵測器，這裡會讀取 config.json 的設定與 bestn.pt
            self.detector = ProductDetector(model_path="bestn.pt", conf_threshold=0.5)
            # 嘗試載入設定檔中自訂的價錢對應表
            import json
